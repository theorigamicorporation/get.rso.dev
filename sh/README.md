...
```bash
curl -sL get.rso.dev/sh/get-pc-info | bash
...
curl -sL get.rso.dev/sh/get-jq | sh -s -- --method=github-release

# Update existing install
curl -sL get.rso.dev/sh/get-jq | sh -s -- --update

# Force reinstall
curl -sL get.rso.dev/sh/get-jq | sh -s -- --force
```
...
```bash
# Default install
curl -sL get.rso.dev/sh/get-yq | sh
...
# Specific install method
curl -sL get.rso.dev/sh/get-yq | sh -s -- --method=github-release

# Update existing install
curl -sL get.rso.dev/sh/get-yq | sh -s -- --update
```
