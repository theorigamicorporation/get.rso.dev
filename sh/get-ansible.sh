...
TOOL_CMD="ansible"
APT_PKG="ansible"
# EL ships ansible-core in appstream; the "ansible" metapackage is Debian-only
DNF_PKG="ansible-core"
...
usage() {
    cat <<'USAGE'
Usage: get-ansible.sh [OPTIONS]

Install ansible across Linux distributions with automatic distro detection.
