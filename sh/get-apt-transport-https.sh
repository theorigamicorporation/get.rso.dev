...
# =============================================================================
# @description HTTPS transport for APT package downloads
# @category System Tools
# @tags apt, https, transport, security
# @supported Ubuntu, Debian, Mint
# @methods apt, dnf, yum
# @verify command -v apt
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET APT-TRANSPORT-HTTPS"

TOOL_NAME="apt-transport-https"
TOOL_CMD="apt"
APT_PKG="apt-transport-https"
DNF_PKG="apt-transport-https"
...
usage() {
    cat <<'USAGE'
Usage: get-apt-transport-https.sh [OPTIONS]

Install apt-transport-https across Linux distributions with automatic distro detection.
