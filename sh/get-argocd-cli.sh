...
# =============================================================================
# @description CLI for Argo CD GitOps continuous delivery
...
usage() {
    cat <<'USAGE'
Usage: get-argocd-cli.sh [OPTIONS]

Install argocd across Linux distributions with automatic distro detection.
...
install_via_github_release() {
    ...
    case "$_ARCH" in
        amd64) _asset="argocd-linux-amd64" ;;
        arm64) _asset="argocd-linux-arm64" ;;
