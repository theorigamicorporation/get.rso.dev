...
# @methods apt, dnf, yum
# @verify command -v bash
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET BASH-COMPLETION"

###########################
# Configuration
###########################
TOOL_NAME="bash-completion"
TOOL_CMD="bash"
APT_PKG="bash-completion"
DNF_PKG="bash-completion"
...
usage() {
    cat <<'USAGE'
Usage: get-bash-completion.sh [OPTIONS]

Install bash-completion across Linux distributions with automatic distro detection.
