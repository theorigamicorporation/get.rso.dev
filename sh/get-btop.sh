...
# =============================================================================
# @description Resource monitor with advanced CPU, memory, and process stats
...
usage() {
    cat <<'USAGE'
Usage: get-btop.sh [OPTIONS]

Install btop across Linux distributions with automatic distro detection.

Options:
  -i, --interactive       Show interactive menu to pick install method
  -m, --method=METHOD     Use specific install method:
                            apt, dnf, yum, snap, github-release
