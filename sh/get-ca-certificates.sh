...
# =============================================================================
# @description Common CA certificates for SSL/TLS verification
# @category Security Tools
# @tags ssl, tls, certificates, ca, trust
# @supported Ubuntu, Debian, Mint, RHEL, Rocky, Amazon Linux
# @methods apt, dnf, yum
# @verify command -v update-ca-certificates || command -v update-ca-trust
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET CA-CERTIFICATES"

###########################
# Configuration
###########################
TOOL_NAME="ca-certificates"
TOOL_CMD="update-ca-certificates"
...
usage() {
    cat <<'USAGE'
Usage: get-ca-certificates.sh [OPTIONS]

Install ca-certificates across Linux distributions with automatic distro detection.
