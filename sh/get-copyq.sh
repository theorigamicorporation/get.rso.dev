...
# @methods apt, dnf, yum
# @verify command -v copyq
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET COPYQ"
...
usage() {
    cat <<'USAGE'
Usage: get-copyq.sh [OPTIONS]

Install copyq across Linux distributions with automatic distro detection.
