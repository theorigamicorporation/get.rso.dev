...
#shellcheck shell=sh
# =============================================================================
# get-eksctl.sh — Install eksctl across Linux distributions
# Usage: curl -sL get.rso.dev/sh/get-eksctl | sh
#        sh get-eksctl.sh [--method=github-release]
#        sh get-eksctl.sh --interactive
#        sh get-eksctl.sh --update
# =============================================================================
...
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET EKSCTL"

TOOL_NAME="eksctl"
TOOL_CMD="eksctl"
GITHUB_REPO="eksctl-io/eksctl"
...
usage() {
    cat <<'USAGE'
Usage: get-eksctl.sh [OPTIONS]

Install eksctl across Linux distributions with automatic distro detection.
...
Examples:
  curl -sL get.rso.dev/sh/get-eksctl | sh
  sh get-eksctl.sh --method=github-release
  sh get-eksctl.sh --interactive
  sh get-eksctl.sh --update
USAGE
...
install_via_github_release() {
    ...
    case "$_ARCH" in
        amd64) _asset="eksctl_Linux_amd64.tar.gz" ;;
        arm64) _asset="eksctl_Linux_arm64.tar.gz" ;;
    ...
    _binary=$(find "$_tmp_dir" -name "eksctl" -type f | head -1)
