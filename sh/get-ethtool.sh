...
# =============================================================================
# @description Query and control network device driver and hardware settings
...
usage() {
    cat <<'USAGE'
Usage: get-ethtool.sh [OPTIONS]

Install ethtool across Linux distributions with automatic distro detection.
