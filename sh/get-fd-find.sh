...
#shellcheck shell=sh
# =============================================================================
# get-fd-find.sh — Install fd-find across Linux distributions
# Usage: curl -sL get.rso.dev/sh/get-fd-find | sh
#        sh get-fd-find.sh [--method=apt, dnf, yum, github-release]
#        sh get-fd-find.sh --interactive
#        sh get-fd-find.sh --update
# =============================================================================
...
usage() {
    cat <<'USAGE'
Usage: get-fd-find.sh [OPTIONS]

Install fd-find across Linux distributions with automatic distro detection.
...
Examples:
  curl -sL get.rso.dev/sh/get-fd-find | sh
  sh get-fd-find.sh --method=github-release
  sh get-fd-find.sh --interactive
  sh get-fd-find.sh --update
USAGE
}
...
install_via_github_release() {
    ...
    case "$_ARCH" in
        amd64) _asset="fd-v${_version_num}-x86_64-unknown-linux-gnu.tar.gz" ;;
        arm64) _asset="fd-v${_version_num}-aarch64-unknown-linux-gnu.tar.gz" ;;
