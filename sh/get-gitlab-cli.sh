...
# =============================================================================
# @description Official command-line tool for GitLab
...
usage() {
    cat <<'USAGE'
Usage: get-gitlab-cli.sh [OPTIONS]

Install glab across Linux distributions with automatic distro detection.
...
install_via_github_release() {
    ...
    _binary=$(find "$_tmp_dir" -name "glab" -type f | head -1)
