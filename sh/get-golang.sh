...
# =============================================================================
# @description Fast statically typed compiled language by Google
...
usage() {
    cat <<'USAGE'
Usage: get-golang.sh [OPTIONS]

Install golang across Linux distributions with automatic distro detection.
