...
# =============================================================================
# @description Network reachability testing utility
# @category Networking Tools
# @tags network, ping, icmp, diagnostic
# @supported Ubuntu, Debian, Mint, RHEL, Rocky, Amazon Linux
# @methods apt, dnf, yum
# @verify command -v ping
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET IPUTILS-PING"

###########################
# Configuration
###########################
TOOL_NAME="iputils-ping"
TOOL_CMD="ping"
APT_PKG="iputils-ping"
DNF_PKG="iputils"
...
usage() {
    cat <<'USAGE'
Usage: get-iputils-ping.sh [OPTIONS]

Install iputils-ping across Linux distributions with automatic distro detection.
