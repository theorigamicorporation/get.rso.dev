...
# Usage: curl -sL get.rso.dev/sh/get-jq | sh
...
Examples:
  curl -sL get.rso.dev/sh/get-jq | sh
...
# Extract version number from a version string (strip prefixes like "jq-", "v")
normalize_version() {
...
install_via_github_release() {
    ...
    # jq asset naming: jq-linux-amd64
    _asset_name="jq-linux-${_ARCH}"
