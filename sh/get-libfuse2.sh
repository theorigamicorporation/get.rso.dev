...
# =============================================================================
# @description FUSE library for AppImage and userspace filesystem support
...
TOOL_CMD="fusermount"
APT_PKG="libfuse2"
# libfuse2 is the Debian name; EL calls the runtime library fuse-libs
DNF_PKG="fuse-libs"
...
usage() {
    cat <<'USAGE'
Usage: get-libfuse2.sh [OPTIONS]

Install libfuse2 across Linux distributions with automatic distro detection.
