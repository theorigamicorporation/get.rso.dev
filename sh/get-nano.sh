...
# =============================================================================
# @description Simple and easy terminal text editor
# @category Editors
...
usage() {
    cat <<'USAGE'
Usage: get-nano.sh [OPTIONS]

Install nano across Linux distributions with automatic distro detection.
