...
# =============================================================================
# @description Classic networking utilities (ifconfig, netstat, route)
# @category Networking Tools
# @tags network, ifconfig, netstat, route, arp
# @supported Ubuntu, Debian, Mint, RHEL, Rocky, Amazon Linux
# @methods apt, dnf, yum
# @verify command -v ifconfig
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET NET-TOOLS"
...
usage() {
    cat <<'USAGE'
Usage: get-net-tools.sh [OPTIONS]

Install net-tools across Linux distributions with automatic distro detection.
