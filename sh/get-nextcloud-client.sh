...
# =============================================================================
# @description Sync client for Nextcloud self-hosted cloud storage
# @category Cloud Tools
# @tags cloud, sync, storage, nextcloud, self-hosted
# @supported Ubuntu, Debian, Mint
# @methods apt, dnf, yum
# @verify command -v nextcloud
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET NEXTCLOUD-DESKTOP"

TOOL_NAME="nextcloud-desktop"
TOOL_CMD="nextcloud"
APT_PKG="nextcloud-desktop"
DNF_PKG="nextcloud-desktop"
...
usage() {
    cat <<'USAGE'
Usage: get-nextcloud-client.sh [OPTIONS]

Install nextcloud-desktop across Linux distributions with automatic distro detection.
