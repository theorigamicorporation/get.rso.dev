...
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET ONLYOFFICE-DESKTOPEDITORS"

TOOL_NAME="onlyoffice-desktopeditors"
TOOL_CMD="onlyoffice-desktopeditors"
APT_PKG="onlyoffice-desktopeditors"
DNF_PKG="onlyoffice-desktopeditors"
...
Install onlyoffice-desktopeditors across Linux distributions with automatic distro detection.
