...
# =============================================================================
# @description System process monitoring utilities (ps, top, free, vmstat)
...
usage() {
    cat <<'USAGE'
Usage: get-procps.sh [OPTIONS]

Install procps across Linux distributions with automatic distro detection.
