...
# =============================================================================
# @description Open-source remote desktop with self-hosted server option
...
usage() {
    cat <<'USAGE'
Usage: get-rustdesk.sh [OPTIONS]

Install rustdesk across Linux distributions with automatic distro detection.
