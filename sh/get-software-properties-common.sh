...
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET SOFTWARE-PROPERTIES-COMMON"
...
usage() {
    cat <<'USAGE'
Usage: get-software-properties-common.sh [OPTIONS]

Install software-properties-common across Linux distributions with automatic distro detection.
