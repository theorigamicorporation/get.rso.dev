...
# =============================================================================
# @description Simple and flexible tool for managing encrypted secrets
...
usage() {
    cat <<'USAGE'
Usage: get-sops.sh [OPTIONS]

Install sops across Linux distributions with automatic distro detection.
...
install_via_github_release() {
    ...
    case "$_ARCH" in
        amd64) _asset="sops-v${_version_num}.linux.amd64" ;;
        arm64) _asset="sops-v${_version_num}.linux.arm64" ;;
