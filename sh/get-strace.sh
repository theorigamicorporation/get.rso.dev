...
# =============================================================================
# @description System call tracer for debugging and diagnostics
...
usage() {
    cat <<'USAGE'
Usage: get-strace.sh [OPTIONS]

Install strace across Linux distributions with automatic distro detection.
