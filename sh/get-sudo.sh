...
# =============================================================================
# @description Execute commands as another user securely
...
usage() {
    cat <<'USAGE'
Usage: get-sudo.sh [OPTIONS]

Install sudo across Linux distributions with automatic distro detection.
