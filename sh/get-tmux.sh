...
# =============================================================================
# @description Terminal multiplexer with window management
...
usage() {
    cat <<'USAGE'
Usage: get-tmux.sh [OPTIONS]

Install tmux across Linux distributions with automatic distro detection.
