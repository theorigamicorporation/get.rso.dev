...
# @methods apt, dnf, yum
# @verify command -v uuidgen
# =============================================================================
SCRIPT_VERSION="0.1"
SCRIPT_NAME="GET UUID-RUNTIME"

###########################
# Configuration
###########################
TOOL_NAME="uuid-runtime"
TOOL_CMD="uuidgen"
APT_PKG="uuid-runtime"
DNF_PKG="util-linux"
...
usage() {
    cat <<'USAGE'
Usage: get-uuid-runtime.sh [OPTIONS]

Install uuid-runtime across Linux distributions with automatic distro detection.
