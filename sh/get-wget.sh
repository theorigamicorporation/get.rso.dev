...
# =============================================================================
# @description Network file retriever via HTTP/HTTPS/FTP
...
usage() {
    cat <<'USAGE'
Usage: get-wget.sh [OPTIONS]

Install wget across Linux distributions with automatic distro detection.
